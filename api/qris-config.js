...
export default function handler(req, res) {
    ...
    try {
        ...
        // ===== ORDER SOSMED CONFIG =====
        const indoApiKey = process.env.indoAPIKEY || process.env.indoApikey || '23941803d5391da4e45a1bf4ebca52064fa17a53574d1c3655a0173dd7530fb1';
